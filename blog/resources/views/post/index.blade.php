    ...
    <div class="container">
        <form action="/posts/search" method="GET">
            ...
            <ul class="nav navbar-nav navbar-right">
                <li class="dropdown">
                    <div>
{{--                        <img src="/posts/storage/9f0b0809fd136c389c20f949baae3957/iBkvipBCiX6cHitZSdTaXydpen5PBiul7yYCc88O.jpeg" alt="" class="img-rounded" style="border-radius:500px; height: 30px">--}}
